...
namespace Resourceedge.Common.Handlers
{
   public  class Handler : IHandler
    {
        ...
        private Func<ResourceedgeException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<ResourceedgeException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (ResourceedgeException customException)
            {
                isFailure = true;
