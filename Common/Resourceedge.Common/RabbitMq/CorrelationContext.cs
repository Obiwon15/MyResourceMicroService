...
namespace Resourceedge.Common.RabbitMq
{
    public class CorrelationContext : ICorrelationContext
    {
        ...
        [JsonConstructor]
        private CorrelationContext(Guid id, string userId, string resourceId, string traceId, string spanContext,
        ...
        public static ICorrelationContext Create<T>(Guid id, string userId, string resourceId, string origin,
