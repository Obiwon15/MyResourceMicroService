...
namespace Resourceedge.Employee.API.Controllers
{
    ...
    public class OldEmployeeController : ControllerBase
    {
        ...
        {
            var employeeToReturn = mapper.Map<OldEmployeeForViewDto>(EmployeeRepo.GetEmployeeByEmployeeId(Id));
        ...
        public IActionResult AllEmployee()
        {
            ...
            var resultToReturn = mapper.Map<IEnumerable<OldEmployeeDto>>(result);
