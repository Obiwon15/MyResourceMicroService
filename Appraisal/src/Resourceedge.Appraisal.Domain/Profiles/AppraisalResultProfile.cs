    ...
    class AppraisalResultProfile : Profile
    {
        public AppraisalResultProfile()
        {
            ...
            CreateMap<AppraisalResultForCreationDto, AppraisalResultForCreationDtoString>()
                .ForMember(des => des.AppraisalConfigId, opt => opt.MapFrom(src => src.AppraisalConfigId.ToString()))
            ...
            CreateMap<AppraisalPerformanceDto, AppraisalPerforanceForCreationDto>()
                .ForMember(des => des.KeyResultAreaId, opt => opt.MapFrom(src => ObjectId.Parse(src.KeyResultAreaId)))
                .ForMember(des => des.KeyOutcomeScore, opt => opt.MapFrom(src => src.KeyOutcomeScore)); 

            CreateMap<OldEmployeeDto, AppraisalsForReviewDto>()
                .ForMember(des => des.FullName, opt => opt.MapFrom(src => src.FullName))
                .ForMember(des => des.Email, opt => opt.MapFrom(src => src.Email))
                .ForMember(des => des.Company, opt => opt.MapFrom(src => src.Subgroup.Name));

            CreateMap<AppraisalPerforanceForCreationDto, AppraisalResult>();
